...
def main(args):
    ...
    if args.print_trace:
        generate_trace_report(
            ...
            batch_size=20,
            input_size=(800, 800),
            filename="trace_cpu.json",
        )
        generate_trace_report(
            model, device, batch_size=20, input_size=(800, 800), filename="trace.json"
        )
...
def parse_args(argv):
    ...
    parser.add_argument(
        "--print_trace", default=False, action="store_true", help="print a trace report"
    )
